...
function wpaicgHumanTime($time){
    ...
    return sprintf(
        ...
        __('%s ago','gpt3-ai-content-generator'),
        $wpaicg_output
    );    
}
$agents = array(
...
<p><?php echo sprintf(
    ...
    esc_html__('GPT agents function alongside server-side cron jobs. To deploy them, you need to set up cron jobs by following the detailed guide %1$shere%2$s','gpt3-ai-content-generator'),
