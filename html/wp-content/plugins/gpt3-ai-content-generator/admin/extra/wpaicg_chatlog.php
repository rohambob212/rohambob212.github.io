...
$wpaicg_current_time = strtotime(date("Y-m-d H:i:s"));
$wpaicg_today_start = strtotime(date("Y-m-d 00:00:00"));
$wpaicg_today_end = strtotime(date("Y-m-d 23:59:59"));
...
<form action="" method="get">
    ...
    <div class="wpaicg-d-flex mb-5">
        ...
        <!-- Export Logs Button -->
            <button id="wpaicg_export_btn" class="button button-primary wpaicg-spacing">
...
<script>
    jQuery(document).ready(function ($){
        ...
        $('#wpaicg_export_btn').click(function(e) {
            e.preventDefault();
            $.post(ajaxurl, { action: 'wpaicg_export_logs' }, function(response) {
