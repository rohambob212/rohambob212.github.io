...
if(!class_exists('\\WPAICG\\WPAICG_Chat')) {
    class WPAICG_Chat
    {
        ...
        function wpaicg_export_logs_callback() {
            ...
            $file_path = $upload_dir['basedir'] . '/wpaicg_chat_logs.txt';
            $file_url = $upload_dir['baseurl'] . '/wpaicg_chat_logs.txt'; // URL for the exported file
...
//                $wpaicg_message = urldecode($wpaicg_message);
                ...
                if (!empty($wpaicg_message)) {
                    ...
                    $models = ['gpt-3.5-turbo', 'gpt-3.5-turbo-16k', 'gpt-4', 'gpt-4-32k'];  // Pre-defined models
