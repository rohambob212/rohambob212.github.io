        ...
        public function wpaicg_woo_content_generator()
        {
            ...
            if(
                ...
                if ($_REQUEST['step'] != 'shorten_url' && $_REQUEST['step'] != 'enforce_focus_keyword_in_url') {
                    ...
                    if($wpaicg_ai_model == 'gpt-3.5-turbo' || $wpaicg_ai_model == 'gpt-3.5-turbo-16k' || $wpaicg_ai_model == 'gpt-4' || $wpaicg_ai_model == 'gpt-4-32k' || $wpaicg_ai_model == 'gpt-3.5-turbo-instruct'){
                    ...
                    wooGenerateContent.click(function (){
                        if(!wpaicgWooContentAjax){
                            ...
                            if(ids.length === 0){
                                ...
                                $language_upper = '';
                                if (!$wpaicg_woo_custom_prompt) {
                                    $language = $wpdb->get_var("SELECT wpai_language FROM wp_wpaicg LIMIT 1");
